...
namespace BethsPies.Migrations
{
    ...
    [Migration("20191007141629_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethsPies.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BethsPies.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BethsPies.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethsPies.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethsPies.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethsPies.Models.OrderDetail", b =>
                {
                    b.HasOne("BethsPies.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethsPies.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethsPies.Models.Pie", b =>
                {
                    b.HasOne("BethsPies.Models.Category", "Category")
                        .WithMany("Pies")
